              ...
              <div className="sticky top-24">
                <div className="relative bg-background-light rounded-lg overflow-hidden">
                  ...
                  {product.isLimitedEdition && (
                    <div className="absolute top-4 left-4 bg-primary text-text-primary text-sm font-bold px-3 py-1 rounded-md">
                      LIMITED EDITION
                    </div>
                  )}
                  
                  {product.isSoldOut && (
                    <div className="absolute top-4 right-4 bg-error text-text-primary text-sm font-bold px-3 py-1 rounded-md">
                      SOLD OUT
                    </div>
                  )}
                </div>
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8">
                  ...
                  <div className="flex items-center">
                    <button
                      ...
                      className="px-3 py-2 bg-background-light text-text-primary rounded-l-md border border-gray-700"
                    ...
                    <input
                      ...
                      className="w-16 px-3 py-2 bg-background-light text-center text-text-primary border-t border-b border-gray-700 focus:outline-none"
                      disabled={product.isSoldOut}
                    />
                    <button
                      onClick={() => setQuantity(quantity + 1)}
                      className="px-3 py-2 bg-background-light text-text-primary rounded-r-md border border-gray-700"
                      disabled={product.isSoldOut}
                    >
                      +
                    </button>
                ...
                <div className="border-t border-gray-700 pt-6 space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-text-primary">Free Shipping</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-text-primary">30-Day Returns</h4>
                      <p className="text-text-secondary text-sm">
